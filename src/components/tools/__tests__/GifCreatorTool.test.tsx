...
describe('GifCreatorTool', () => {
  ...
  it('should render the GIF editor tool', () => {
    ...
    expect(screen.getByText('Create animated GIFs from images with timeline control and custom settings')).toBeVisible();
  });
  ...
  it('should show empty state when no frames are added', () => {
    ...
    expect(screen.getByText('Timeline will appear here once you add images')).toBeVisible();
  });
  ...
  it('should allow preset selection', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByRole('option', { name: 'High Quality' })).toBeVisible();
  ...
  it('should update dimensions when preset changes', async () => {
    ...
    const highQualityOption = screen.getByRole('option', { name: 'High Quality' });
  ...
  it('should handle maintain aspect ratio toggle', async () => {
    ...
    const aspectRatioSwitch = screen.getByRole('checkbox', { name: /maintain aspect ratio/i });
  ...
  it('should handle file upload', async () => {
    ...
    const fileInput = addImagesButton.querySelector('input[type="file"]') as HTMLInputElement;
